    ...
    return (
        <>
            <section className="w-[90%] m-auto pb-10">
                ...
                <div className="flex items-center max-w-[600px] m-auto h-[300px]">
                    <div className="bg-[#256f9a] h-full rounded-l-[40px] p-10">
                        <Image src={ProductCharger} alt="product image" className="max-w-[200px]"/>
                    </div>
                    <div className="bg-[#0c2d48] h-full rounded-r-[40px] p-10">
                        <p className="text-white text-[20px]">
                            Order now and get a discount as a special gift.
                        </p>
                        <button className="bg-white px-5 py-3 mt-3 text-[17px] text-[#0c2d48] rounded-3xl">Buy now</button>
                    </div>
                </div>
            </section>
        </>
